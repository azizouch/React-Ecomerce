        ...
        <div className="mb-6 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center flex-1">
            ...
            <select
              ...
              className="px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition text-sm font-medium appearance-none cursor-pointer pr-8 bg-no-repeat bg-right bg-contain min-w-[180px]"
              style={{
